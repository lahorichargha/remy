...
public class RecipeDefinitions
{
	...
	public static Recipe getRatatouille()
    {
        ...
        steps.add(new Step(2, "Remove the parsley and basil leaves from their stems"));
        steps.add(new Step(3, "Dice the green bell pepper, eggplant, and onion"));
        steps.add(new Step(4, "Quarter the zucchini lengthwise then slice into 1/4-in. (1/2 cm) segments. "));
        steps.add(new Step(5, "Quarter the mushrooms"));
        steps.add(new Step(6, "Chop the parsley and the basil."));

        steps.add(new Step(7, "Start cooking by heating olive oil in a large pot over medium heat."));
        steps.add(new Step(8, "Add the minced garlic and saute until the garlic smell intensifies, about one minute."));
        steps.add(new Step(9, "Add the diced onion and continue to saute until they turn translucent, about 4 more minutes."));
        steps.add(new Step(10, "Once the onions are translucent, add 1 Tbs. tomato paste. The tomato paste will be in a clump and will take a bit of stirring and pressing to get it to spread out and cover the onions and garlic."));
        steps.add(new Step(11, "As you work at spreading the paste out and mixing it with the onions and garlic, the paste will cook and darken in color. Once some of the paste starts to stick to the pan and brown, it's time to add the stock (about one minute)."));
        steps.add(new Step(12, "Pour in 3/4 cup chicken or vegetable stock and stir until the broth begins to simmer. Using your spatula or utensil, scrub the bottom of the pan to release any browned bits of garlic, onion, or tomato paste."));
        steps.add(new Step(13, "Add the diced eggplant, zucchini, bell peppers, and mushrooms. Stir to combine thoroughly and cook for 10 to 12 minutes, stirring every couple minutes to promote even heating."));
        steps.add(new Step(14, "The eggplant will release a lot of liquid (slowly) into the pot and it's in this liquid that you'll want to simmer the other ingredients in. To evenly cook all the ingredients, you'll have to stir it to make sure the vegetables spend time touching eggplant liquid. As a bonus, the flavors mix amazingly well during this process."));
        steps.add(new Step(15, "The eggplant will mostly be falling apart at this point, but the zucchini, bell peppers, and mushrooms should be tender but not yet mushy."));
        steps.add(new Step(16, "Add the diced tomatoes and stir in. After about a minute, the tomatoes will have heated through. Turn the heat down to the lowest setting."));
        steps.add(new Step(17, "Stir in the chopped parsley and basil. Add salt and pepper to taste."));
        ...
        ingredients.add(new Ingredient(valueOf(5, COUNT), "sprigs of italian parsley"));
        ...
        ingredients.add(new Ingredient(valueOf(1, COUNT), "medium green bell pepper"));
        ingredients.add(new Ingredient(valueOf(1, COUNT), "large eggplant"));
        
        List<Tool> tools = new ArrayList<Tool>();
        
        Recipe recipe = new Recipe("Ratatouille", steps, ingredients, tools);
    ...
    public static Recipe getOatCookie()
    {
        ...
        ingredients.add(new Ingredient(valueOf(1.5, TEASPOON), "vanilla extract"));
        ...
        Recipe recipe = new Recipe("OatCookies", steps, ingredients, tools);
        return recipe;
    }

    public static List<Recipe> getAll() {
		ReturnCollectingMethodCallback recipeCollector = new ReturnCollectingMethodCallback(Recipe.class);
		ReflectionUtils.doWithMethods(RecipeDefinitions.class, 
		recipeCollector,
